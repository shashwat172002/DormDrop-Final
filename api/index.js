...
const io = new Server(server, {
  cors: {
    origin: "https://dorm-drop-backend.vercel.app/",     //http://localhost:5173  //https://dormdrop.onrender.com
    methods:["GET","POST"],
    credentials:true,
  },
});
...
app.use(cors(
  {
    origin: "https://dorm-drop-backend.vercel.app/",       //https://dormdrop.onrender.com  //http://localhost:5173
  }
))
